...
public class SendCode {
	...
	public static boolean send(String phoneNumber, String code) {
		...
		try {
			...
			req.setSmsFreeSignName("InstantMessage");
	...
	public static boolean sendEmail(String emailaddress, String code) {
		...
		try {
			...
			email.setFrom("qiuyuyan1012@163.com", "qiuInstantMessage");

			email.setAuthentication("qiuyuyan1012@163.com", "qlp199588");

			email.setSubject("qiuInstantMessage");
