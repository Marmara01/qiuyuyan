...
public class LiaotianFrame extends JFrame implements WindowListener {
	 ...
	 * Create the frame
	 */
	public LiaotianFrame(String uidStr, String netnameStr, String imgStr, String infoStr, Vector<Msg> msgs) {
		super(); 
		this.uidStr = uidStr;
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				...
				try {
					...
					msg.setToUID(LiaotianFrame.this.uidStr);
